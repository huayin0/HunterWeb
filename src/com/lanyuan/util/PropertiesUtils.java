 ...
 * PropertiesUtils.class.getResourceAsStream("/config/properties/config.properties"); 　解决办法：
 * 　String savePath =
 * PropertiesUtils.class.getResource("/config/properties/config.properties").getPath();
 * 
...
public class PropertiesUtils
{
	...
	public static Properties getProperties()
	{
		...
		String savePath = PropertiesUtils.class.getResource(
				"/config/properties/config.properties").getPath();
		// 以下方法读取属性文件会缓存问题
		// InputStream in = PropertiesUtils.class
		// .getResourceAsStream("/config/properties/config.properties");
		try
